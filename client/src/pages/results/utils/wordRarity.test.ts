...
describe('wordRarity', () => {
  it('maps every score the engine produces to its tier', () => {
    ...
    expect(wordRarity(8)).toBe('legendary');
    expect(wordRarity(13)).toBe('mythic');
  });
