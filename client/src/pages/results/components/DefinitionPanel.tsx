...
export function DefinitionPanel({ word }: DefinitionPanelProps) {
  ...
  return (
    <div className="p-3 text-small text-[var(--text-mid)] flex-1 overflow-y-auto min-h-0 font-[family-name:var(--font-serif)] font-normal leading-[19.5px]">
      {loading ? (
        ...
        <>
          <div className="flex items-baseline gap-2 mb-2">
            ...
            {definition.phonetic && (
              <span className="text-small text-[var(--text-muted)] italic">{definition.phonetic}</span>
            )}
          </div>
